...
public class ForgetPassFragment extends Fragment {
    ...
    ForgetPassFragmentModelFactory factory;
    ForgetPassViewModel homeViewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        binding = ActivityForgetPasswordBinding.inflate(inflater,container,false);
        fullScreen();
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        factory = new ForgetPassFragmentModelFactory(requireContext(),binding);
        homeViewModel = new ViewModelProvider(this,factory).get(ForgetPassViewModel.class);
        ...
        binding.forgetUser.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                navController.navigate(R.id.nav_forget_name_fragment);
            }
        });
