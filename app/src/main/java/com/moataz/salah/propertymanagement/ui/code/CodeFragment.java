...
public class CodeFragment extends Fragment {
    ...
    CodeFragmentModelFactory factory;
    CodeViewModel homeViewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        binding = ActivityCodeBinding.inflate(inflater,container,false);
        fullScreen();
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        factory = new CodeFragmentModelFactory(requireContext(),binding);
        homeViewModel = new ViewModelProvider(this,factory).get(CodeViewModel.class);
