...
public class CustomerFragment extends Fragment {
    ...
    CustomerViewModel homeViewModel;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        factory = new CustomerModelFactory(requireContext(),binding);
        homeViewModel = new ViewModelProvider(this,factory).get(CustomerViewModel.class);
        ...
        if (userPreference.getApp().getCustmerAdd() == 0){
            binding.barcode.setVisibility(View.GONE);
        }else if (userPreference.getApp().getCustmerAdd() == 1){
