...
public class PrinterFragment extends Fragment{
    ...
    PrinterModelFactory factory;
    PrinterViewModel homeViewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        binding = PrinterFragmentBinding.inflate(inflater,container,false);
        fullScreen();
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        factory = new PrinterModelFactory(requireContext(),binding);
        homeViewModel = new ViewModelProvider(this,factory).get(PrinterViewModel.class);
        ...
        binding.newBt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.e("click" , "click");
                homeViewModel.addPrinter();
            }
        });
    }
