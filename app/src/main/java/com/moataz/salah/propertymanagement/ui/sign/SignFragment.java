...
public class SignFragment extends Fragment {
    ...
    SignFragmentModelFactory factory;
    SignViewModel homeViewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        binding = ActivitySignBinding.inflate(inflater,container,false);
        fullScreen();
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        factory = new SignFragmentModelFactory(requireContext(),binding);
        homeViewModel = new ViewModelProvider(this,factory).get(SignViewModel.class);
        ...
        homeViewModel.intUi(binding,getContext(),navController,image_body);
        ...
        binding.displayRGB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        binding.signBt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                binding.signLoader.setVisibility(View.VISIBLE);
                homeViewModel.sign();
            }
        });
