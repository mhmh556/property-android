...
public class ChartFragment extends Fragment {
    ...
    ChartFragmentModelFactory factory;
    ChartViewModel homeViewModel;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        factory = new ChartFragmentModelFactory(requireContext(),binding);
        homeViewModel = new ViewModelProvider(this,factory).get(ChartViewModel.class);
